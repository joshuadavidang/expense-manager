<template>
  <nav
    class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-gray-800 bg-green-100"
  >
    <div
      class="container flex flex-wrap justify-between items-center mx-auto p-4"
    >
